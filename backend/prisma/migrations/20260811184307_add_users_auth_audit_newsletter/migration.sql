...
-- CreateEnum
CREATE TYPE "Audience" AS ENUM ('cuidadores_familiares', 'profesionales', 'ambos');

-- CreateEnum
CREATE TYPE "ArticleStatus" AS ENUM ('borrador', 'publicado', 'archivado');
...
CREATE TABLE "articles" (
    ...
    "audience" "Audience" NOT NULL DEFAULT 'ambos',
