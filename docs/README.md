...
- [`features/content-tracks.md`](features/content-tracks.md) — Eje temático (`ContentTrack`: acompañamiento terapéutico / cuidado de mayores / recursos profesionales AT) como filtro suave y persistente, para que cada público vea menos "ruido" del otro sin ocultarlo. **Estado: diseño — pendiente de implementar.**
